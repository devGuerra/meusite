    ...
    <footer>
      <div className="seo-content">
        <div className="footer-text">
          <div className="cWrap px-1">
            <h2>O que é o gerazap</h2>
            <p>
              Nós somos o melhor site de
              <strong>Links de Grupos de WhatsApp</strong> na internet. Aqui
              você encontra os melhores grupos de whatsapp para participar. Além
              disso, você também pode cadastrar seu grupo do whatsapp enviando o
              link. Dessa forma, muitas pessoas encontrarão o seu grupo de
              whatsapp e você terá muitos novos participantes. Você pode
              participar de quantos grupos do whatsapp desejar, sem limites, e
              também pode enviar quantos grupos quiser.
            </p>
            ...
            <ol>
              ...
              <li>
                Na lista de amigos, selecione os participantes do grupo inicial
                e clique em <strong>Avançar</strong>.
              </li>
              <li>Digite o nome do grupo de whatsapp que será criado.</li>
              <li>
                Clique no ícone da câmera e adicione uma foto ao seu grupo.
              </li>
              <li>
                Por fim, clique no botão <strong>Criar</strong>.
              </li>
            </ol>
            ...
            <ol>
              ...
              <li>
                Por fim, clique em <strong>Excluir grupo</strong>.
              </li>
            </ol>
            <p>
            ...
            <p>
              ...
              que temos. No momento, você não pode procurar grupos de whatsapp
            ...
            <ol>
              ...
              <li>
                Pesquise o grupo ao qual você deseja entrar nas várias
                categorias do nosso site.
              </li>
            ...
            <p>
              Para adicionar alguém a um grupo de WhatsApp, siga as etapas
              abaixo:
            </p>
            <ol>
              <li>
            ...
            <ol>
              <li>
                Abra o Whatsapp e clique no grupo que você deseja fazer a
                chamada.
              </li>
              <li>
            ...
            <p>
              ...
              aplicativo, o WhatsApp decidiu no ano de 2016 aumentar a
              capacidade de 100 para 256.
            </p>
            <h2>Como criar uma página para o meu grupo de WhatsApp?</h2>
            <p>
              Criando uma página para o seu grupo de WhatsApp, você poderá dar
              mais informações aos integrantes do seu grupo. Através de uma
              página você pode cadastrar a descrição do grupo, regras que devem
              ser seguidas e até mesmo quais são os administradores do grupo.
            </p>
            <p>
              Dessa forma, você não precisará escrever uma descrição longa no
              seu grupo, basta compartilhar o link da página e pronto!
            </p>
            <p>
